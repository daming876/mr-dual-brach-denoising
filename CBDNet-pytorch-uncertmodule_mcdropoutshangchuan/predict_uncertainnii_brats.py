...
#input_folder = "/mnt/gemlab_data/Medical_image_database/MRI/segmentation/jmf-result/0Brain_1666files/"
input_folder =  "/mnt/gemlab_data_2/jiang/CBDNet/brats_gli_zhuoneng_origin/"   
#pathfile="/mnt/gemlab_data_2/jiang/CBDNet/prostate_denoised_nii/"        
pathfile="/mnt/gemlab_data_2/jiang/CBDNet/bratscali5000epochs/"       
output_folder = os.path.join(pathfile,"noisyqiepian") 
output_folder2 = os.path.join(pathfile,"calibration_denoised5000epochs") 
...
if os.path.exists(os.path.join(save_dir, 'calibration5000checkpoint.pth.tar')):
    # load existing model
    model_info = torch.load(os.path.join(save_dir, 'calibration5000checkpoint.pth.tar'))
